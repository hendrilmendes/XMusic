...
import 'package:xmusic/CustomWidgets/playlist_popupmenu.dart';
...
class SongsListPage extends StatefulWidget {
  ...
  const SongsListPage({super.key, required this.listItem});
  ...
  void _fetchSongs() {
    ...
    try {
      switch (widget.listItem['type'].toString()) {
        ...
        case 'album':
          SaavnAPI().fetchAlbumSongs(widget.listItem['id'].toString()).then((
            value,
          ) {
            setState(() {
        ...
        case 'playlist':
          SaavnAPI().fetchPlaylistSongs(widget.listItem['id'].toString()).then((
            value,
          ) {
            setState(() {
              songList = value['songs'] as List;
        ...
        body:
            !fetched
                ...
                : BouncyPlaylistHeaderScrollView(
                  ...
                  title:
                      widget.listItem['title']?.toString().unescape() ??
                      'Songs',
                  ...
                  imageUrl:
                      UrlImageGetter([
                        widget.listItem['image']?.toString(),
                      ]).mediumQuality,
                        ...
                        return ListTile(
                          ...
                          trailing: Row(
                            ...
                            children: [
                              ...
                              LikeButton(mediaItem: null, data: entry),
