...
class _DownloadedSongsState extends State<DownloadedSongs>
  ...
  Future<void> sortSongs(int sortVal, int order) async {
    ...
    switch (sortVal) {
      case 0:
        _songs.sort((a, b) => a.displayName.compareTo(b.displayName));
      case 1:
        _songs.sort(
          (a, b) => a.dateAdded.toString().compareTo(b.dateAdded.toString()),
        );
      case 2:
        _songs.sort((a, b) => a.album.toString().compareTo(b.album.toString()));
      case 3:
        _songs.sort(
      ...
      case 5:
        _songs.sort((a, b) => a.size.toString().compareTo(b.size.toString()));
      default:
        _songs.sort(
          (a, b) => a.dateAdded.toString().compareTo(b.dateAdded.toString()),
        );
    ...
    return GradientContainer(
      child: DefaultTabController(
        ...
        child: Scaffold(
          ...
          appBar: AppBar(
            title: Text(widget.title ?? AppLocalizations.of(context)!.myMusic),
            bottom: TabBar(
              ...
              tabs: [
                ...
                Tab(text: AppLocalizations.of(context)!.folders),
            ...
            actions: [
              IconButton(
                ...
                onPressed: () {
                  showSearch(
                    context: context,
                    delegate: DataSearch(data: _songs, tempPath: tempPath!),
                  );
                },
              ),
            ...
            itemBuilder: (context, index) {
              ...
              return ListTile(
                leading: OfflineAudioQuery.offlineArtworkWidget(
                  ...
                  fileName:
                      widget
                          .albums[widget.albumsList[index]]![0]
                          .displayNameWOExt,
                ),
