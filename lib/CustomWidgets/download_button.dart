...
import 'package:xmusic/Services/download.dart';
...
class _DownloadButtonState extends State<DownloadButton> {
  ...
  Widget build(BuildContext context) {
    return SizedBox.square(
      ...
      child: Center(
        child:
            (downloadsBox.containsKey(widget.data['id']))
                ? IconButton(
                        ...
                        child: ValueListenableBuilder(
                          ...
                          child: Center(
                            child: IconButton(
                              ...
                              tooltip: AppLocalizations.of(context)!.stopDown,
                              onPressed: () {
                                down.download = false;
                              },
                            ),
                            ...
                            return AnimatedContainer(
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  Visibility(visible: showValue, child: child!),
                                ],
                              ),
                            );
                          },
...
class _MultiDownloadButtonState extends State<MultiDownloadButton> {
  ...
  Widget build(BuildContext context) {
    ...
    return SizedBox(
      ...
      child: Center(
        child:
            (down.lastDownloadId == widget.data.last['id'])
                ? IconButton(
                  icon: const Icon(Icons.download_done_rounded),
                ...
                ? Center(
                  child: IconButton(
                    ...
                    onPressed: () async {
                      ...
                      data =
                          (await SaavnAPI().fetchAlbumSongs(
                                widget.albumId,
                              ))['songs']
                              as List;
