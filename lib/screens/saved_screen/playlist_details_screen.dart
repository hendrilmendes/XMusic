...
class PlaylistDetailsScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return playlist == null
        ? AdaptiveScaffold(body: Center(child: Text(S.of(context).Not_Available)))
        : AdaptiveScaffold(
                                ...
                                Modals.showConfirmBottomModal(
                                  ...
                                  if (confirm) {
                                    context
                                        ...
                                        .then(
                                          (message) => BottomMessage.showText(
                                            context,
                                            message,
                                          ),
                                        );
                ...
                AdaptiveFilledButton(
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      Text(S.of(context).Play_All, style: const TextStyle(fontSize: 18)),
                    ],
                  ),
                ),
            ],
