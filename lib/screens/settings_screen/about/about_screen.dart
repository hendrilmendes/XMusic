                ...
                child: ListView(
                  ...
                  children: [
                    ...
                    AdaptiveListTile(
                      ...
                      onTap:
                          () => launchUrl(
                            Uri.parse('https://hendrilmendes.github.io'),
                            mode: LaunchMode.externalApplication,
                          ),
                    ),
                    AdaptiveListTile(
                    ...
                    AdaptiveListTile(
                      ...
                      onTap:
                          () => launchUrl(
                            Uri.parse('https://t.me/hendril_mendes'),
                            mode: LaunchMode.externalApplication,
                          ),
                    ),
                    AdaptiveListTile(
                      ...
                      onTap:
                          () => launchUrl(
                            Uri.parse(
                              'https://github.com/hendrilmendes/XMusic/contributors',
                            ),
                            mode: LaunchMode.externalApplication,
                          ),
                    ),
                    ...
                    AdaptiveListTile(
                      ...
                      onTap:
                          () => launchUrl(
                            Uri.parse(
                              'https://github.com/hendrilmendes/XMusic/issues/new?assignees=&labels=bug&projects=&template=bug_report.yaml',
                            ),
                            mode: LaunchMode.externalApplication,
                          ),
                    ),
                    AdaptiveListTile(
                      ...
                      onTap:
                          () => launchUrl(
                            Uri.parse(
                              'https://github.com/hendrilmendes/XMusic/issues/new?assignees=hendrilmendes&labels=enhancement%2CFeature+Request&projects=&template=feature_request.yaml',
                            ),
                            mode: LaunchMode.externalApplication,
                          ),
                    ),
