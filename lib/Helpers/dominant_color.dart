...
Future<List<Color>> getColors({required ImageProvider imageProvider}) async {
  ...
  if (dominantColor.computeLuminance() < darkMutedColor.computeLuminance()) {
    ...
    GetIt.I<MyTheme>().playGradientColor = [darkMutedColor, dominantColor];
    ...
    GetIt.I<MyTheme>().playGradientColor = [lightMutedColor, darkMutedColor];
    return [lightMutedColor, darkMutedColor];
  } else {
    GetIt.I<MyTheme>().playGradientColor = [dominantColor, darkMutedColor];
    return [dominantColor, darkMutedColor];
  }
}
